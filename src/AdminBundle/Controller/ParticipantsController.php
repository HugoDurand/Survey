...
class ParticipantsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('AdminBundle:Participants:index.html.twig', array(
    ...
    public function editParticipantAction(Request $request)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $participant = $em->getRepository('AppBundle:Participants')->findOneById($request->get('id'));
        ...
        return $this->render('AdminBundle:Participants:edit.html.twig', array(
    ...
    public function addParticipantAction(Request $request)
    {
        ...
        return $this->render('AdminBundle:Participants:add.html.twig', array(
            'form' => $form->createView(),
        ));
    }
    ...
    public function showParticipantAction(Request $request)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $participant = $em->getRepository('AppBundle:Participants')->findOneById($request->get('id'));
        $session = $em->getRepository('AppBundle:Session')->findOneById($participant->getSession());
        $reponse = $em->getRepository('AppBundle:Reponse')->findOneByNumParticipant($participant->getNumParticipant());
        $questionnaire = $em->getRepository('AppBundle:Questionnaires')->findOneById($session->getIdQuestionnaire());
        ...
        $questions = $em->getRepository('AppBundle:Questions')->findById($id_question);
        ...
        return $this->render('AdminBundle:Participants:show.html.twig', array(

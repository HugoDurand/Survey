...
class QuestionnaireController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $questionnaire = $em->getRepository('AppBundle:Questionnaires')->findById([1, $request->get('id')]);
        $question = $em->getRepository('AppBundle:Questions')->findByIdQuestionnaire([$questionnaire[0]->getId(),$questionnaire[1]->getId()]);
        ...
        $questelem = $em->getRepository('AppBundle:Questelem')->findByIdQuestion($idQuestion);
        ...
        if (isset($data['submit'])){
            ...
            $reponse_participant = new Reponse();
